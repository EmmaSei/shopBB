...
public class CsvAPIUpdateTest {
    ...
    public void testUpdateCustomer() throws Exception {
        try{
           System.out.println("Update Custemer");
            CsvAPI instance = new CsvAPI();
            Customer obj= new Customer(9876543L,"Pavel", "Zorge zh", "9876543456","pasha@mail.ru");
            Result result;
    ...
    public void testUpdateOrder() throws Exception {
        try{
           System.out.println("Update Payment");
            CsvAPI instance = new CsvAPI();
            Order obj= new Order(1482176292007L, "12A765", 4236346435343L ,19122016,"sended", new Payment(1482176292007L, "card", 19122016, 2), 3, 4567876543L);
            Result result;
            result = instance.update(obj);
            assertEquals(StatusType.GOOD.toString(), result.getStatus());
        } catch (Exception e) {
